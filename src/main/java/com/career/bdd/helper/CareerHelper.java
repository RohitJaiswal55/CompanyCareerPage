...
public class CareerHelper {
	private WebDriver driver; // Ensuring WebDriver is initialized properly
	...
	public void setup() {
		...
		careerPage = new CareerPage(driver); // Ensure CareerPage is initialized after WebDriver
	}
	...
	public void launchCareerPage() throws InterruptedException {
		...
		String baseURL = config.getProperty(CareerConstant.BASE_URL); // Directly fetching baseURL key
